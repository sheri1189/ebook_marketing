            ...
            <div class="col-lg-6 mx-auto">
                <div class="card">
                    <div class="card-header align-items-center d-flex pt-3">
                        <h4 class="card-title mb-0 flex-grow-1">Add Plan</h4>
                    </div>
                    <div class="card-body">
                        <div class="live-preview">
                            <form id="form_submit" class="row g-3 needs-validation" novalidate>
                                <div class="col-12">
                                    ...
                                    <input type="hidden" id="end_point_url" value="{{ url('/plans/store') }}">
                                    <input type="hidden" id="module_name" value="Plan">
                                    <input type="hidden" id="button_text" value="Add">
                                    <input type="text" name="name" oninput="NameValidation(this)"
                                        value="{{ old('name') }}" placeholder="Enter Plan Name"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-envelope-square me-3"></i> Prompt Queries-</span>
                                        <input type="number" min="1" name="prompt_queries"
                                            oninput="FacilityValidation(this)" value="{{ old('prompt_queries') }}"
                                            placeholder="Enter Messages" class="form-control" required
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="currency" value="{{ __('USD') }}"
                                        class="form-control" required autocomplete="off" readonly required>
                                    <strong class="text-danger" id="currency"></strong>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Billing Period *</label>
                                    <select class="form-control" name="billing_period" autocomplete="off"
                                        required>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" rows="3" oninput="AlphaNumericValidation(this)" value="{{ old('description') }}"
                                        placeholder="Enter Plan Description" class="form-control" required autocomplete="off">{{ old('description') }}</textarea>
                                ...
                                <div class="col-6 text-end">
                                    <button class="btn rounded-pill btn-primary waves-effect waves-light"
                                        type="submit" id="insert">Add Plan > </button>
                                </div>
                            </form>
                        </div>
                    </div>
