        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link scrollupto" href="{{ url('/#about') }}">About Us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/#featured-ebooks') }}">Featured eBooks</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/#pricing') }}">Our Pricing</a>
                    </li>
                    <li class="nav-item">
