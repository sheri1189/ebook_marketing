                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                <img src="{{ asset('admin/assets/images/sidebar/img-1.jpg') }}" alt=""
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                <img src="{{ asset('admin/assets/images/sidebar/img-2.jpg') }}" alt=""
                                    class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                <img src="{{ asset('admin/assets/images/sidebar/img-3.jpg') }}" alt=""
                                    class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                <img src="{{ asset('admin/assets/images/sidebar/img-4.jpg') }}" alt=""
                                    class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                    </div>
...
<script src="{{ asset('admin/assets/js/pages/card.init.js') }}"></script>
...
<script src="{{ asset('admin/assets/libs/fg-emoji-picker/fgEmojiPicker.js') }}"></script>
<script src="{{ asset('admin/assets/js/pages/chat.init.js') }}"></script>
...
<script src="{{ asset('admin/assets/js/pages/pricing.init.js') }}"></script>
<script src="{{ asset('admin/assets/js/app.js') }}"></script>
<script src="{{ asset('admin/assets/libs/%40ckeditor/ckeditor5-build-classic/build/ckeditor.js') }}"></script>
<script src="{{ asset('admin/assets/js/pages/form-editor.init.js') }}"></script>
<script src="{{ asset('admin/assets/libs/masonry-layout/masonry.pkgd.min.js') }}"></script>
...
<script src="{{ asset('admin/assets/js/insert_data.js') }}"></script>
<script src="{{ asset('admin/assets/js/delete_data.js') }}"></script>
<script src="{{ asset('admin/assets/js/update_data.js') }}"></script>
<script src="{{ asset('admin/assets/js/restore_data.js') }}"></script>
<script src="{{ asset('admin/assets/js/view_data.js') }}"></script>
<script src="{{ asset('admin/assets/js/csv_working.js') }}"></script>
...
@yield('script')
<script src="{{ asset('admin/assets/js/datatables_buttons.js') }}"></script>
