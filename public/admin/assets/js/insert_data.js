                            ...
                            complete: function () {
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        if (response.module == "csv" || response.module == "font" && response.message == 202) {
                                            var progressBar = $('.progress-bar');
                                            var percentageText = $('#percentage');
                                            ...
                                            $("#previewDivZip").fadeOut();
                                            $("#previewDivTTF").fadeOut();
                                            $("#previewDiv").fadeOut();
                                            ...
                                            $("#previewDivTTF").fadeOut();
                                            $("#previewDiv").fadeOut();
                                        } else if (response.module == "font" && response.message == "not_ttf") {
                                            Swal.fire({
                                                toast: true,
                                                icon: "error",
                                                title: "Files must be TTF into the Zip File...!",
                                                animation: false,
                                                position: "top-right",
                                                showConfirmButton: false,
                                                timer: 3000,
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.module == "template" && response.message == 200) {
                                    ...
                                    gettingData();
                                } else if (response.message == 200, response.module == "plan") {
                                    $("form").trigger("reset");
                                    form.classList.remove("was-validated");
                                    button.removeAttribute("disabled");
                                    button.innerHTML = button_text + " " + module_name + " >";
